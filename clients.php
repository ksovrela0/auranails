...
<body class="main-body">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">კლიენტები და შეტყობინებები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">მომხმარებლები და კომუნიკაცია</a></li>
							<li class="breadcrumb-item active" aria-current="page">კლიენტები და შეტყობინებები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	function LoadKendoTable_incomming(hidden){
		...
		var actions         = 	'<div class="btn btn-list"><a id="add_new_client" style="color:white;" class="btn ripple btn-primary new_add"><i class="fas fa-plus-square"></i> დამატება</a><a id="send_sms" style="color:white;" class="btn ripple btn-primary new_add">SMS გაგზავნა მონიშნულებთან</a></div>';
		var editType        =   "popup"; // Two types "popup" and "inline"
		var itemPerPage     = 	20;
		var columnsCount    =	5;
		var columnsSQL      = 	[
		...
		const kendo = new kendoUI();
		kendo.loadKendoUI(aJaxURL,'get_list_clients',itemPerPage,columnsCount,columnsSQL,gridName,actions,editType,columnGeoNames,filtersCustomOperators,showOperatorsByColumns,selectors,hidden, 1, locked, lockable);
